...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_item_list = 21,                 /* item_list  */
  YYSYMBOL_item = 22,                      /* item  */
...
{
       0,    62,    62,    66,    69,    71,    75,    76,    80,    84,
      91,    98,   102,   106,   111,   115,   119,   123,   127
};
#endif
...
{
  "\"end of file\"", "error", "\"invalid token\"", "SCL", "ARR",
  "IDENTIFIER", "NUMBER", "'+'", "'-'", "'*'", "'/'", "UMINUS", "'{'",
  "'}'", "';'", "'='", "'('", "')'", "$accept", "program", "block",
  "item_list", "item", "declaration", "assignment", "expression", YY_NULLPTR
};
...
{
     -10,   -11,    15,   -11,     5,   -11,    14,    16,    17,   -11,
     -11,   -11,   -11,     6,    18,    -5,   -11,    25,   -11,   -11,
      -5,    -5,    19,    21,   -11,    -3,    -5,    -5,    -5,    -5,
     -11,    22,   -11,     3,     3,   -11,   -11,   -11
};
...
{
       0,     4,     0,     2,     0,     1,     0,     0,     0,     3,
       5,     6,     7,     0,     0,     0,     8,     0,    12,    11,
       0,     0,     0,     0,    14,     0,     0,     0,     0,     0,
      10,     0,    13,    15,    16,    17,    18,     9
};
...
{
      18,    19,     1,    20,    26,    27,    28,    29,     6,     7,
       8,    21,    28,    29,    32,     5,    24,    25,     9,    13,
      16,    14,    33,    34,    35,    36,    26,    27,    28,    29,
      17,    23,    15,    30,    31,     0,    37
};

static const yytype_int8 yycheck[] =
{
       5,     6,    12,     8,     7,     8,     9,    10,     3,     4,
       5,    16,     9,    10,    17,     0,    20,    21,    13,     5,
      14,     5,    26,    27,    28,    29,     7,     8,     9,    10,
      12,     6,    15,    14,    13,    -1,    14
};
...
{
       0,    12,    19,    20,    21,     0,     3,     4,     5,    13,
      22,    23,    24,     5,     5,    15,    14,    12,     5,     6,
       8,    16,    25,     6,    25,    25,     7,     8,     9,    10,
      14,    13,    17,    25,    25,    25,    25,    14
};
...
yyreduce:
  ...
  switch (yyn)
    {
  case 8: /* declaration: SCL IDENTIFIER ';'  */
#line 81 "parser.y"
    {
        declare_scalar((yyvsp[-1].str));
    }
#line 1132 "parser.tab.c"
    break;

  case 9: /* declaration: ARR IDENTIFIER '{' NUMBER '}' ';'  */
#line 85 "parser.y"
    {
        declare_array((yyvsp[-4].str), (yyvsp[-2].num));
    }
#line 1140 "parser.tab.c"
    break;

  case 10: /* assignment: IDENTIFIER '=' expression ';'  */
#line 92 "parser.y"
    {
        assign_scalar((yyvsp[-3].str), (yyvsp[-1].str));
    }
...
#line 99 "parser.y"
    {
        (yyval.str) = format_string("%d", (yyvsp[0].num));
    }
...
#line 103 "parser.y"
    {
        (yyval.str) = use_identifier((yyvsp[0].str));
    }
...
#line 107 "parser.y"
    {
        (yyval.str) = format_string("(%s)", (yyvsp[-1].str));
        free((yyvsp[-1].str));
    }
...
#line 112 "parser.y"
    {
        (yyval.str) = make_unary_expression((yyvsp[0].str));
    }
...
#line 116 "parser.y"
    {
        (yyval.str) = make_binary_expression((yyvsp[-2].str), "+", (yyvsp[0].str));
    }
